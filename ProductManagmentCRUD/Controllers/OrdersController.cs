...
namespace ProductManagmentCRUD.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrdersId,CustomerId,OrderDate")] Orders orders)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrdersId,CustomerId,OrderDate")] Orders orders)
        {
            if (ModelState.IsValid)
            {
